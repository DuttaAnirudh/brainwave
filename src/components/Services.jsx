        ...
        <div className="relative">
          ...
          >
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              <h4 className="h4 mb-[1rem]">Smartest AI</h4>
              <p className="body-2 mb-[3rem] text-n-3">
                Brainwave unlocks the potential of AI-powered applications
              </p>
              <ul className="body-2">
                {brainwaveServices.map((item, i) => (
                  <li className="mb-2 py-3" key={i}>
                    <div className="flex items-center">
                      <img src={check} width={24} height={24} alt="check" />
                      <h6 className="body-2 ml-4">{item}</h6>
                    </div>
                  </li>
                ))}
              </ul>
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            >
              ...
              >
                <h4 className="h4 mb-[1rem]">Photo editing</h4>
                <p className="body-2 mb-[3rem] text-n-3">
            ...
            >
              ...
              {/* SERVICE 4 */}
              <div
                className="relative h-[20rem] bg-n-8 rouned-xl 
